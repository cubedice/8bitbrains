...
%-----------------------------------------------------------------------------------------------------------
	...
	function  output = filter2_mlab_mat (stimulation, output)
	coef_matrix=[9 21 8 -20 -17 1 -53 -119 0 207 160 -10 163 362 -285 -1325 -1003 889 2047 889 -1003 -1325 -285 362 163 -10 160 207 0 -119 -53 1 -17 -20 8 21 9 ];
	INTER_FACTOR  = 1;
	DECI_FACTOR  = 1; 
	MSB_RM  = 0;
	MSB_TYPE  = 0;
